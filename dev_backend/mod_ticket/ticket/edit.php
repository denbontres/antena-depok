                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="?module=Edit-Proses-Ticket"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="txtSub" class="form-control" value="<?php echo $data['subject'] ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="txtDesk" class="form-control" placeholder="Textarea" rows="5"><?php echo "$txtDesk" ?></textarea>
                                    </div>
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Attachment Baru</label>
                                    <div class="col-md-9">
