...
if ($_GET) {
    if(isset($_POST['btnEdit']))
    {
      ...
      {
        echo "<script>alert('Update data berhasil! Klik ok untuk melanjutkan');location.replace('?page=Data-Kategori')</script>";
      } 
        else 
        {
			    ...
			    <div class="col-md-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="?page=Edit-Kategori" method="post" name="frmadd" target="_self"> 
